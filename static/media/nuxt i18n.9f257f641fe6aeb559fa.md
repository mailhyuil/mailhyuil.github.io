...
<template>
  ...
  <div class="flex gap-3 items-center">
    ...
    <p
      class="cursor-pointer text-white font-mono text-sm transition-all"
      :class="locale === 'ko' ? 'border-b-[3px]' : 'opacity-50'"
      @click.prevent.stop="setLocale('ko')">
      K r
    </p>
    <p
      class="cursor-pointer text-white font-mono text-sm transition-all"
      :class="locale === 'en' ? 'border-b-[3px]' : 'opacity-50'"
